...
var author$project$Main$init = {value: 0};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var newValue = msg.a;
				var _n1 = elm$core$String$toInt(newValue);
				if (_n1.$ === 'Just') {
					var intValue = _n1.a;
					return _Utils_update(
						model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('value-input')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('value-buttons')
					]),
				_List_fromArray(
					[
						A2(
